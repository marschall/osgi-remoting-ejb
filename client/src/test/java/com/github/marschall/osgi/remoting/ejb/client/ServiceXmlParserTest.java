...
public class ServiceXmlParserTest {
  ...
  public void parseSampleJBossXml() throws IOException, XMLStreamException {
    ...
    assertEquals("ejb:jboss-osgi-remoting-sample-ear/osgi-remoting-ejb-sample-ejb//StatelessBean!com.github.marschall.jboss.osgi.remoting.StatelessRemote1", service.jndiName);
    ...
    assertEquals("ejb:jboss-osgi-remoting-sample-ear/osgi-remoting-ejb-sample-ejb//StatelessBean!com.github.marschall.jboss.osgi.remoting.StatelessRemote2", service.jndiName);
    
    service = result.services.get(2);
    assertEquals("com.github.marschall.jboss.osgi.remoting.StatefulRemote1", service.interfaceName);
    assertEquals("ejb:jboss-osgi-remoting-sample-ear/osgi-remoting-ejb-sample-ejb//StatefulBean!com.github.marschall.jboss.osgi.remoting.StatefulRemote1?stateful", service.jndiName);
    
    service = result.services.get(3);
    assertEquals("com.github.marschall.jboss.osgi.remoting.StatefulRemote2", service.interfaceName);
    assertEquals("ejb:jboss-osgi-remoting-sample-ear/osgi-remoting-ejb-sample-ejb//StatefulBean!com.github.marschall.jboss.osgi.remoting.StatefulRemote2?stateful", service.jndiName);
  }
